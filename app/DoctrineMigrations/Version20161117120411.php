 ...
 */
class Version20161117120411 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE category (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE city (id INT AUTO_INCREMENT NOT NULL, country_id VARCHAR(2) DEFAULT NULL, name VARCHAR(255) NOT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_2D5B0234F92F3E70 (country_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE country (code VARCHAR(2) NOT NULL, name VARCHAR(255) NOT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY(code)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE keyword (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE place (id INT AUTO_INCREMENT NOT NULL, city_id INT DEFAULT NULL, category_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, zip VARCHAR(6) NOT NULL, phone VARCHAR(10) NOT NULL, web_address VARCHAR(255) NOT NULL, open_hours VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, is_claimed TINYINT(1) NOT NULL, is_closed TINYINT(1) NOT NULL, coord_latitude VARCHAR(255) NOT NULL, coord_longitude VARCHAR(255) NOT NULL, image_url VARCHAR(255) NOT NULL, gmap_id INT DEFAULT NULL, created_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, INDEX IDX_741D53CD8BAC62AF (city_id), INDEX IDX_741D53CD12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE place_keyword (place_id INT NOT NULL, keyword_id INT NOT NULL, INDEX IDX_6E5F66C0DA6A219 (place_id), INDEX IDX_6E5F66C0115D4552 (keyword_id), PRIMARY KEY(place_id, keyword_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE city ADD CONSTRAINT FK_2D5B0234F92F3E70 FOREIGN KEY (country_id) REFERENCES country (code)');
        ...
        $this->addSql('ALTER TABLE place_keyword ADD CONSTRAINT FK_6E5F66C0DA6A219 FOREIGN KEY (place_id) REFERENCES place (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE place_keyword ADD CONSTRAINT FK_6E5F66C0115D4552 FOREIGN KEY (keyword_id) REFERENCES keyword (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE place_keyword DROP FOREIGN KEY FK_6E5F66C0115D4552');
        $this->addSql('ALTER TABLE place_keyword DROP FOREIGN KEY FK_6E5F66C0DA6A219');
        ...
        $this->addSql('DROP TABLE place_keyword');
